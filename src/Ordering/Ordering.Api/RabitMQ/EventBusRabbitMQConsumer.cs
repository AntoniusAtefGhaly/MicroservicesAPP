...
namespace Ordering.Api.RabitMQ
{
    public class EventBusRabbitMQConsumer
    {
        ...
        public void Consume()
        {
            var channel = _connection.CreatModel();
            ...
            channel.BasicConsume(queue: EventBusConstants.BasketCheckoutQueue, autoAck: true, consumer: consumer,noLocal:false,arguments:null);
        }
